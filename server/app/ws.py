...
def notify_speakers_merged(source_id: int, target_id: int, name: str,
    ...
    узнает. Без этого следующая короткая реплика уехала бы на удалённого — и
    теперь, на PostgreSQL, это уже не тихая порча данных, а ошибка внешнего
    ключа посреди живой встречи. Пока база была SQLite, ключи не проверялись, и
    реплика молча записывалась ссылкой в никуда: её не находил ни один участник.
