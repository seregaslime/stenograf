...
class Settings(BaseSettings):
    ...
    # Половина — потому что у рассуждающих моделей мысли идут из этого же лимита
    # и стоят столько же, сколько сам ответ (замер: 832 токена мыслей на 822
    # токена текста).
    llm_api_output_share: float = 0.5
