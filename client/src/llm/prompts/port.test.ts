...
// 17.09.2026 системный текст этого промпта в эталоне обновлён намеренно:
// появились документы базы знаний (пункт 5а). Перенесённая с сервера версия
// осталась в истории git; формат фрагментов встреч не менялся. Новый текст
// выбран по ответам qwen3:4b — см. комментарий в searchAnswer.ts.
